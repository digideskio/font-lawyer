 ...
 */
define( 'flcache', '/var/www/FontLawyer/cache/' );
define( 'fl_site_root', '/var/www/' );  // <- trailing slash not optional
define( 'fldescriptions', '/var/www/FontLawyer/cache/' );

/*
 * Silent font lawyer output error log.
 */
define( 'flerrlogfile', '/var/www/FontLawyer/cache/fl-log.txt' );
define( 'FL_FILE_EOL', "\n" );
